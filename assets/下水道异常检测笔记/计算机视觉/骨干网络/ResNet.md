# ResNet
它是深度学习和计算机视觉里非常重要的经典网络，很多后续模型都直接或间接受到它影响。你可以把它理解为：
...
## 三十三、如果面试官追问：BasicBlock 和 Bottleneck 有什么区别？
...
## 三十四、如果面试官追问：ResNet 和 VGG 有什么区别？
...
## 三十五、如果面试官追问：ResNet 中 shortcut 什么时候需要 1×1 卷积？
